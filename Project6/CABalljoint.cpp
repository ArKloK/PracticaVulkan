...
//
void CABalljoint::createBuffers(CAVulkanState* vulkan)
{
	CAMaterial jointMat = {};
...
//
// FUNCIÓN: CABalljoint::updateDescriptorSets(CAVulkanState* vulkan, uint32_t imageIndex, glm::mat4 view, glm::mat4 projection)
//
// PROPÓSITO: Actualiza las variables uniformes
//
void CABalljoint::updateDescriptorSets(CAVulkanState* vulkan, uint32_t imageIndex, glm::mat4 view, glm::mat4 projection)
{
	joint->updateDescriptorSets(vulkan, imageIndex, view, projection);
...
//
void CABalljoint::destroyBuffers(CAVulkanState* vulkan)
{
	joint->destroyBuffers(vulkan);
	bone->destroyBuffers(vulkan);
}
